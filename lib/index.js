...
var DiffViewer = /** @class */ (function (_super) {
    ...
    function DiffViewer(props) {
         ...
         */
        _this.renderWordDiff = function (diffArray, renderer, renderContext) {
            return diffArray.map(function (wordDiff, i) {
                ...
                return (React.createElement("span", { key: i, className: classnames_1.default(_this.styles.wordDiff, (_a = {},
                        ...
                        _a)) }, renderer
                    ? renderer(wordDiff.value, renderContext, diffArray)
                    : wordDiff.value));
            });
        };
        /**
         ...
         */
        _this.renderLine = function (renderContext) {
            var _a, _b, _c, _d;
            var lineNumber = renderContext.lineNumber, type = renderContext.type, prefix = renderContext.prefix, value = renderContext.value, additionalLineNumber = renderContext.additionalLineNumber, additionalPrefix = renderContext.additionalPrefix;
            ...
            if (Array.isArray(value)) {
                content = _this.renderWordDiff(value, _this.props.renderContent, renderContext);
            }
            else if (_this.props.renderContent) {
                content = _this.props.renderContent(value, renderContext);
            }
            else {
                content = value;
            }
        ...
        _this.renderInlineView = function (_a, index) {
            ...
            if (left.type === compute_lines_1.DiffType.REMOVED && right.type === compute_lines_1.DiffType.ADDED) {
                return (React.createElement(React.Fragment, { key: index },
                    React.createElement("tr", { className: _this.styles.line }, _this.renderLine({
                        lineNumber: left.lineNumber,
                        type: left.type,
                        prefix: LineNumberPrefix.LEFT,
                        value: left.value,
